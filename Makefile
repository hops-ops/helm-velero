...
PACKAGE ?= helm-velero
XRD_DIR := apis/veleros
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/veleros/standard.yaml
...
EXAMPLES := \
    examples/veleros/minimal.yaml:: \
    examples/veleros/standard.yaml::
